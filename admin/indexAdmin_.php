...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="lib/css/comon.css"/>
    <link rel="stylesheet" type="text/css" href="lib/css/indexstyle.css"/>
    <link rel="stylesheet" type="text/css" href="lib/css/Hetzer.css"/>
    <link rel="stylesheet" type="text/css" href="lib/css/info.css"/>
    <link rel="stylesheet" type="text/css" href="lib/css/register.css">
    <link rel="stylesheet" type="text/css" href="lib/css/contactus.css">
...
<header id=header>
    <img src="images/FV214.jpg" alt="FV214" width=100% height="400px">
</header>
